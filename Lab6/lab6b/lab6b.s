...
.section .data
    input1:     .space 11  #buffer
    input2:     .space 20  #buffer
    Yb:         .space 2   #ordenada de b
    Xc:         .space 2   #absissa de c
...
read: 
    ...
    la a1, input1           #buffer to read the data
...
calculate_sqrt:
    ...
    li t1, 20       #variável de fim de laço
